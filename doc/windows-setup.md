...
DigiByte Core is slow on startup, especially if you're starting it for the first time and the entire chain of blocks needs to be downloaded. After a while, progress on the sync process will become visible:
